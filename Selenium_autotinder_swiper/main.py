...
FB_EMAIL = "mightypotato@gmail.com"
FB_PASSWORD = "mightypotato96"
...
sleep(2)
login_button = driver.find_element(By.XPATH, '//*[@id="content"]/div/div[1]/div/main/div[1]/div/div/header/div[1]/div['
                                             '2]/div/button')
login_button.click()
...
for n in range(100):
    ...
    try:
        print("called")
        like_button = driver.find_element(By.XPATH, '//*[@id="content"]/div/div[1]/div/main/div[1]/div/div/div['
